...
__all__ = ["readchar", "readkey", "key", "config", "tryreadchar", "tryreadkey", "claim_terminal", "unclaim_terminal"]
...
if platform.startswith(("linux", "darwin", "freebsd", "openbsd", "android")):
    ...
    from ._posix_tryread import tryreadchar, tryreadkey, claim_terminal, unclaim_terminal
elif platform in ("win32", "cygwin"):
    from . import _win_key as key
    from ._win_read import readchar, readkey
    from ._win_tryread import tryreadchar, tryreadkey, claim_terminal, unclaim_terminal
else:
